...
Original file is located at
    https://colab.research.google.com/drive/1GssuLvU2-v9uf1DdL-ArnLOjX5NCfo3w
"""
...
plt.title('Flights Count of Different Airlines',fontsize=10)
...
plt.title('Classes of Different Airlines',fontsize=10)
...
plt.title('Class Vs Ticket Price',fontsize=10)
...
plt.title('Source City Vs Ticket Price',fontsize=12)
plt.xlabel('Source City',fontsize=10)
plt.ylabel('Price',fontsize=10)
plt.subplot(1,2,2)
sns.boxplot(x='destination_city',y='price',data=df,palette='hls')
plt.title('Destination City Vs Ticket Price',fontsize=12)
...
plt.title('Days Left For Departure Versus Ticket Price',fontsize=12)
...
plt.title('Days Left For Departure Versus Ticket Price of each Airline',fontsize=10)
...
a={'Model Name':[], 'Mean_Absolute_Error_MAE':[], 'Adj_R_Square':[], 'Root_Mean_Squared_Error_RMSE':[], 'Mean_Absolute_Percentage_Error_MAPE':[],
...
plt.title('Days Left For Departure Versus Actual Ticket Price and Predicted Ticket Price',fontsize=12)
plt.legend(labels=['Price actual','Price predicted'],fontsize=10)
plt.xlabel('Days Left for Departure',fontsize=10)
plt.ylabel('Actual and Predicted Price',fontsize=10)
plt.show()
...
pk.dump(modelETR, open('model.pkl', 'wb'))
